...
const Button = ({
  ...
  const variantClasses = {
    primary:
      "bg-primary-700 text-[#ffffff] font-semibold hover:bg-primary-700/80 active:trasnlate-y-0",
  ...
  return (
    <div>
      <button
        type="button"
        className={`hover:scale-105 transition duration-700 ease-in-out cursor-pointer px-5 py-2.5 rounded-xl font-medium flex items-center justify-center
